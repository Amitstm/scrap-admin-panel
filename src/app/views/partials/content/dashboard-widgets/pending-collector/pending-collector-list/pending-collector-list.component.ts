...
import { Role, selectAllRoles, User, UserDeleted, UsersDataSource, UsersPageRequested } from 'src/app/core/auth';
...
@Component({
	selector: 'kt-pending-collector-list',
	templateUrl: './pending-collector-list.component.html',
	styleUrls: [ './pending-collector-list.component.scss' ]
})
export class PendingCollectorListComponent implements OnInit {
	@Input() cssClasses = '';
