...
@Component({
	selector: 'kt-pending-collector',
	templateUrl: './pending-collector.component.html',
	styleUrls: [ './pending-collector.component.scss' ]
})
export class PendingCollectorComponent implements OnInit {
	@Input() cssClasses = '';
	chartOptions: any = {};
	fontFamily = '';
	colorsGrayGray500 = '';
	...
	constructor(private layoutConfigService: LayoutConfigService) {
		...
		this.colorsGrayGray500 = this.layoutConfigService.getConfig('js.colors.blue.gray500');
		this.colorsGrayGray200 = this.layoutConfigService.getConfig('js.colors.yellow.gray200');
	...
	getChartOptions() {
		return {
			series: [
				{
					name: 'Net Profit',
					data: [ 40, 40, 30, 30, 35, 35, 50, 80, 70, 20 ]
				}
			],
			chart: {
				type: 'area',
