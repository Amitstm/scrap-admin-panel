...
@Component({
	selector: 'kt-total-collector',
	templateUrl: './total-collector.component.html',
	styleUrls: [ './total-collector.component.scss' ]
})
export class TotalCollectorComponent implements OnInit {
	@Input() cssClasses = '';
	chartOptions: any = {};
	fontFamily = '';
	colorsGrayGray500 = '';
